...
def to_json_names(names):
    ...
    new_list_of_names = [{"coin_name": name.coin_parse,
...
def to_json_all(name, list_of_prices):
    ...
    new_list_of_prices = [[price.coin_time_in_sec * 1000, price.coin_value]
...
def to_json_range_coin(params, list_of_prices):
    ...
    new_list_of_prices = [{"coin_value": price.coin_value, "coin_time": price.coin_time}
                          for price in list_of_prices]
    # for price in list_of_prices:
...
def to_json_range_news(params, list_of_news):
    ...
    new_list_of_news = [{"news_title": news.news_title,
